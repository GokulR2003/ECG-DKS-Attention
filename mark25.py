...
if __name__ == "__main__":
    ...
    # MODIFIED: Epochs set to 25
    history = model.fit(X_train, y_train, epochs=25, batch_size=64, validation_split=0.1, class_weight=class_weights, verbose=1, callbacks=[early_stopping, reduce_lr])
