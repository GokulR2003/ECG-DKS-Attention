...
if __name__ == "__main__":
    ...
    # MODIFIED: Epochs set to 30
    history = model.fit(X_train, y_train, epochs=30, batch_size=64, validation_split=0.1, class_weight=class_weights, verbose=1, callbacks=[early_stopping, reduce_lr])
